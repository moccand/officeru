...
TRACKED_MODELS = (GroupProfile, RuExport)


@receiver(post_save, dispatch_uid='backoffice_log_model_changes')
def log_backoffice_model_changes(sender, instance, created, raw=False, update_fields=None, **kwargs):
